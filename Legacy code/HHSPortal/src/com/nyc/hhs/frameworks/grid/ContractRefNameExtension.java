...
public class ContractRefNameExtension implements DecoratorInterface
{
	...
	public String getControlForColumn(Object aoEachObject, Column aoCol, Integer aoSeqNo)
	{
		...
		String lsControl = "<div class='wordWrap'>"+loContractDetails.getMsContractRefFirstName()+ " " + loContractDetails.getMsContractRefMidName() + " " +
		loContractDetails.getMsContractRefLastName()+"</div>";
		return lsControl;
	}
