...
<%@page import="java.util.List, java.util.Iterator, com.nyc.hhs.model.DocumentPropertiesBean, java.util.Date, com.nyc.hhs.constants.ApplicationConstants, com.nyc.hhs.util.CommonUtil, com.nyc.hhs.constants.ComponentMappingConstant,com.nyc.hhs.util.DateUtil,com.nyc.hhs.constants.HHSConstants,com.nyc.hhs.constants.HHSR5Constants" %>
				...
				while(loIterator.hasNext()){
					...
					<%}else if(loDocPropsBean.getPropertyType().equalsIgnoreCase("date")){ %>
			    		<div class="row">
							...
							<span class="formfield"><input type="text" name="<%=loDocPropsBean.getPropertyId()%>" id="editInput<%=counter%>" value="<%=lsDate%>" style="display:none"/>
							<%-- End : Changes in R5 --%>
