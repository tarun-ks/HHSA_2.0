...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('		<td><img id="bold" class="rteImage" src="' + imagesPath + 'strikethrough.gif" width="25" height="24" alt="strikethrough" title="strikethrough" onClick="rteCommand(\'' + rte + '\', \'strikeThrough\', \'\')"></td>');
			...
			document.writeln('		<td><img id="hyperLinkImage" class="rteImage" src="' + imagesPath + 'hyperlink.gif" width="25" height="24" alt="Insert Link" title="Insert Link" onClick="insertLink(\'' + rte + '\')"></td>');
			document.writeln('		<td><img id="unlinkHyperLinkImage" class="rteImage" src="' + imagesPath + 'unlink.gif" width="25" height="24" alt="Unlink" title="Unlink" onClick="rteCommand(\'' + rte + '\', \'unlink\', \'\')"></td>');
...
function enableDesignMode(rte, html, readOnly) {
	...
	frameHtml += "</head>\n";
	frameHtml += "<body id=\"richTextId\" disabled=true >\n";
	frameHtml += html + "\n";
	frameHtml += "</body>\n";
	frameHtml += "</html>";
