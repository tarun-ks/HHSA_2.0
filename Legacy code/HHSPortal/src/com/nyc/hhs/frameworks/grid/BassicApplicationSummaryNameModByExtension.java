...
public class BassicApplicationSummaryNameModByExtension implements DecoratorInterface {
	...
	public String getControlForColumn(Object aoEachObject, Column aoCol,
		...
		{
			if(null != loBuisinessAppSummary)
			{
				lsControl = loBuisinessAppSummary.getMsModifiedBy();
			}
		}
		return lsControl;
	}
	...
	public String getControlForHeading(Column aoCol)
	{
		...
		String lsDataControlStr = "RESUME"; 
		return lsDataControlStr;
	}
