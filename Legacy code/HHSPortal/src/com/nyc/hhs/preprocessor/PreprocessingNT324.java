...
public class PreprocessingNT324 implements PreProcessingNotificationAlert
{

	private static final LogInfo LOG_OBJECT = new LogInfo(PreprocessingNT324.class);
			...
			throws ApplicationException
	{
		...
		try
		{
			loUserEmailList = (List<UserEmailIdBean>) DAOUtil.masterDAO(aoMyBatisSession, loUserGroupMap,
					ApplicationConstants.MAPPER_CLASS_NOTIFICATION_MAPPER, HHSR5Constants.FETCH_CITY_USER_NT_EXPORT,
					HHSConstants.JAVA_UTIL_HASH_MAP);

		}
		catch (ApplicationException aoExp)
		{
			LOG_OBJECT.Error("Error occurred while Preprocessing324:", aoExp);
		}
		catch (Exception loExp)
		{
			LOG_OBJECT.Error("Error occurred while Preprocessing324:", loExp);
		}
