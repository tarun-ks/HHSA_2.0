...
import com.nyc.hhs.taskhandlers.BudgetAmendmentTaskHandler;

import com.nyc.hhs.util.PropertyLoader;

public class BudgetAmendmentTaskHandlerTest
{
	private static SqlSession moSession = null; // SQL Session

	BudgetAmendmentTaskHandler loBudgetAmendmentTaskHandler = new BudgetAmendmentTaskHandler();
...
//		JUnitUtil.getTransactionManager();
	...
	public void testTaskApprove() throws ApplicationException
	{
		...
		loBudgetAmendmentTaskHandler.taskApprove(loTaskDetailsBean);
	}
	...
	{
		loBudgetAmendmentTaskHandler.taskReturn(null);
	}
	...
	public void testTaskReturn2() throws ApplicationException
	{
		...
		loBudgetAmendmentTaskHandler.taskReturn(loTaskDetailsBean);
	}
	...
	public void testBudgetAmendmentTaskHandlertaskApprove0Negative()
	{
		BudgetAmendmentTaskHandler loBudgetAmendmentTaskHandler = new BudgetAmendmentTaskHandler();
		try
		{
			loBudgetAmendmentTaskHandler.taskApprove(null);
		}
	...
	@Test(expected = java.lang.Exception.class)
	public void testBudgetAmendmentTaskHandlertaskReturn1Negative()
	{
		BudgetAmendmentTaskHandler loBudgetAmendmentTaskHandler = new BudgetAmendmentTaskHandler();
		try
		{
	...
	public void testBudgetAmendmentTaskHandlertaskApprove0NegativeApp() throws ApplicationException
	{
		BudgetAmendmentTaskHandler loBudgetAmendmentTaskHandler = new BudgetAmendmentTaskHandler();
		loBudgetAmendmentTaskHandler.taskApprove(null);
	}
	...
	@Test(expected = ApplicationException.class)
	public void testBudgetAmendmentTaskHandlertaskReturn1NegativeApp() throws ApplicationException
	{
		BudgetAmendmentTaskHandler loBudgetAmendmentTaskHandler = new BudgetAmendmentTaskHandler();
		loBudgetAmendmentTaskHandler.taskReturn(null);
	}
