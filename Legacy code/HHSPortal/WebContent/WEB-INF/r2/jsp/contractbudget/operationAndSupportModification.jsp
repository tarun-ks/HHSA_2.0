<%-- This jsp is used to display modification for operation and support tab, screen S365--%>
...
<div class='formcontainer paymentFormWrapper' style='width:92%'>
 <div class="row">
      <span class="label">Modification Total Operations, Support and Equipment:</span>
...
<%-- Below resource url is for OTPS modification grid headers --%>
<portlet:resourceURL var='SubGridHeaderRow' id='SubGridHeaderRow' escapeXml='false'>
<portlet:param name="gridLabel" value="operationAndSupportModification.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames"><%=HHSUtil.getHeader("operationAndSupportModification.grid")%></c:set>
<c:set var="gridColProp"><%=HHSUtil.getHeaderProp("operationAndSupportModification.grid")%></c:set>
<c:set var="subGridColProp"><%=HHSUtil.getSubGridProp("operationAndSupportModification.grid")%></c:set>

<%-- Below resource url is for fetching/onload of OTPS modification grid--%>
...
<%-- Below resource url is for operations on OTPS modification grid--%>
...
<%-- Below resource url is for Equipment modification grid headers --%>
<portlet:resourceURL var='SubGridHeaderRow1' id='SubGridHeaderRow' escapeXml='false'>
<portlet:param name="gridLabel" value="equipmentModification.grid"/>
</portlet:resourceURL>

<c:set var="gridColNames1"><%=HHSUtil.getHeader("equipmentModification.grid")%></c:set>
<c:set var="gridColProp1"><%=HHSUtil.getHeaderProp("equipmentModification.grid")%></c:set>
<c:set var="subGridColProp1"><%=HHSUtil.getSubGridProp("equipmentModification.grid")%></c:set>

<%-- Below resource url is for fetching/onload of Equipment modification grid--%>
...
<%-- Below resource url is for operations on Equipment modification grid--%>
