...
// executes on page load
    ...
    function View(){
    	var a_href = $("#printerViewCB").attr('href');
    	window.open(a_href); 
    }
...
<h3>Budget Summary <span class='linkPrint'></span>
<p></p>
		<table width="100%" cellspacing='0' cellpadding='0'>				
				...
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalCityFundedBudget.updateAmount}"/></label></td>
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalCityFundedBudget.proposedBudget}"/></label></td>
				</tr>
		</table>
		...
		<%-- "Total Direct Costs" table Starts --%>			
			<table width="92%" cellspacing='0' cellpadding='0'>				
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalDirectsCosts.proposedBudget}"/></label></td>
				</tr>
			</table>
		...
		<%-- "Total Salary and Fringe" Table Starts --%>
			<table width="92%" cellspacing='0' cellpadding='0'>					
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalSalaryAndFringesAmount.proposedBudget}"/></label></td>
				</tr>
					...
					<tr >
						...
						<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalSalary.proposedBudget}"/></label></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>Total Fringe</td>
						...
						<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalFringes.proposedBudget}"/></label></td>
					</tr>
				</tbody>
			</table>
			...
			<table width="92%" cellspacing='0' cellpadding='0' class='summaryWrapper2'>				
					<tr>
						...
						<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalOTPSAmount.proposedBudget}"/></label></td>
					</tr>
					<tbody id='tagging2${changeId}' style='display:none'>
						<tr>
							...
							<td class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.operationsSupportAndEquipmentAmount.proposedBudget}"/></label></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>Utilities</td>
							...
							<td class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.utilitiesAmount.proposedBudget}"/></label></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							...
							<td class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.professionalServicesAmount.proposedBudget}"/></label></td>
						<tr>
							<td>&nbsp;</td>
							...
							<td class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.rentAndOccupancyAmount.proposedBudget}"/></label></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							...
							<td class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.contractedServicesAmount.proposedBudget}"/></label></td>
						</tr>
					</tbody>
			</table>
			...
			<table width="92%" cellspacing='0' cellpadding='0' class='summaryWrapper2'>				
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalRateBasedAmount.proposedBudget}"/></label></td>
				</tr>
			</table>
		...
		<%-- "Total Milestone Based" table Starts --%>			
			<table width="92%" cellspacing='0' cellpadding='0' class='summaryWrapper2'>				
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalMilestoneBasedAmount.proposedBudget}"/></label></td>
				</tr>
			</table>
		...
		<%-- "Unallocated Funds" table Starts --%>			
			<table width="92%" cellspacing='0' cellpadding='0' class=''>				
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.unallocatedFunds.proposedBudget}"/></label></td>
				</tr>
			</table>
		...
		<%-- "Total Indirect Costs" table Starts --%>			
			<table width="92%" cellspacing='0' cellpadding='0'>				
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalIndirectCosts.proposedBudget}"/></label></td>
				</tr>
			</table>
		<%-- "Total Indirect Costs" table Ends Here --%>	
			...
			<table width="100%" cellspacing='0' cellpadding='0'>				
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalProgramIncome.proposedBudget}"/></label></td>
				</tr>
		    </table>
			...
			<table width="100%" cellspacing='0' cellpadding='0'>				
				<tr>
					...
					<td width='13%' class='right'><label><fmt:formatNumber type="currency" value="${budgetSummary.totalProgramBudget.proposedBudget}"/></label></td>
				</tr>
		    </table>
			...
			<c:if test="${SiteDetailsBean[0].statusId eq '84'}">
