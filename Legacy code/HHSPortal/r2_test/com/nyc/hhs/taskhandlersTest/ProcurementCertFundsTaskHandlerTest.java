...
import com.nyc.hhs.taskhandlers.ProcurementCertFundsTaskHandler;
import com.nyc.hhs.util.PropertyLoader;

public class ProcurementCertFundsTaskHandlerTest {


	private static SqlSession moSession = null; // SQL Session

	ProcurementCertFundsTaskHandler loProcurementCertFundsTaskHandler = new ProcurementCertFundsTaskHandler();
...
//		JUnitUtil.getTransactionManager();
	...
	public void testTaskApprove() throws ApplicationException
	{
		...
		loProcurementCertFundsTaskHandler.taskApprove(loTaskDetailsBean);
	}
	...
	{
		loProcurementCertFundsTaskHandler.taskReturn(null);
	}
	...
	public void testTaskReturn2() throws ApplicationException
	{
		...
		loProcurementCertFundsTaskHandler.taskReturn(loTaskDetailsBean);
	}
	...
	public void testProcurementCertFundsTaskHandlertaskApprove0Negative()
	{
		ProcurementCertFundsTaskHandler loProcurementCertFundsTaskHandler = new ProcurementCertFundsTaskHandler();
		try
		{
			loProcurementCertFundsTaskHandler.taskApprove(null);
		}
	...
	@Test(expected = java.lang.Exception.class)
	public void testProcurementCertFundsTaskHandlertaskReturn1Negative()
	{
		ProcurementCertFundsTaskHandler loProcurementCertFundsTaskHandler = new ProcurementCertFundsTaskHandler();
		try
		{
	...
	public void testProcurementCertFundsTaskHandlertaskApprove0NegativeApp() throws ApplicationException
	{
		ProcurementCertFundsTaskHandler loProcurementCertFundsTaskHandler = new ProcurementCertFundsTaskHandler();
		loProcurementCertFundsTaskHandler.taskApprove(null);
	}
	...
	@Test(expected = ApplicationException.class)
	public void testProcurementCertFundsTaskHandlertaskReturn1NegativeApp() throws ApplicationException
	{
		ProcurementCertFundsTaskHandler loProcurementCertFundsTaskHandler = new ProcurementCertFundsTaskHandler();
		loProcurementCertFundsTaskHandler.taskReturn(null);
	}
