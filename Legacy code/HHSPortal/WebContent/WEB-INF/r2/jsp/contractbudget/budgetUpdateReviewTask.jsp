<%-- This jsp display for agency user for reviewing update budget --%>
...
<%-- This portlet resource is for calling showbudgetUpdateTabJsp method to show tab jsp--%>
...
<!-- R6 changes ends-->
<%-- This portlet resource is for saving update budget --%>
...
<c:set var="sectionName"><%=HHSComponentMappingConstant.AGENCY_S427_PAGE%></c:set>
<div class='complianceWrapper'>
<d:content   section="${sectionName}" authorize="" isReadOnly="${accessScreenEnable eq false}">
<task:taskContent workFlowId="" taskType="taskBudgetUpdate" isTaskScreen="" level="header" taskDetail="" ></task:taskContent>
<d:content  isReadOnly="true"  >
	<h2 class='autoWidth'>Contract Budget Update</h2>
	<div class='hr'></div>
...
<div class='gridFormField'>
	<task:taskContent workFlowId="" commentsSection=" " taskType="taskBudgetUpdate"  isTaskScreen=""  level="footer"></task:taskContent>
	</div>
</d:content>
</div>
