...
$(document).ready(function() {
	...
	$("#btnMarkAsRegSubmit").click(function(){
		cancelAndMerge();
	});
...
function cancelAndMergeConfirmation() {
	var IsSubmitCheck=$('#chkSubmitForm').is(':checked');
	var v_parameter = "&" + $("#submitMRForm").serialize()+"&isLaunchNewFYTask="+IsSubmitCheck;
