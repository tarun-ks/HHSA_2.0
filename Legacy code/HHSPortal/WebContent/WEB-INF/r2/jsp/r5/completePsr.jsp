...
<portlet:actionURL var="finishPSRComplete" escapeXml="false">
	<portlet:param name="submit_action" value="finishPSRComplete" />
</portlet:actionURL>
...
<input type="hidden" name="finishPSRComplete" id="finishPSRComplete" value="${finishPSRComplete}" />
...
<script type="text/javascript"
	src="${pageContext.servletContext.contextPath}/r5/js/psrworkflow/completePsr.js"></script>
<portlet:actionURL var="psrReassignURL" escapeXml="false">
	<portlet:param name="submit_action" value="reassignCompletePsrTask" />
</portlet:actionURL>
...
<div>
	<form:form id="psrform" name="psrform" action="${finishPSRComplete}" method="post" commandName="PsrBean">
		<div class="skipElementsInCompare">
			...
			<input type="hidden" value="${psrReassignURL}" id="psrReassignURL" /> 
		...
		<div class="complianceWrapper">
				...
				<div class="messagedivover failed" id="ErrorDiv">
					<span id="topLevelError" style="color:#d63301;"></span>
			...
			<div class="tasktopfilter taskButtons">
				<div class="taskfilter skipElementsInCompare">
				...
				<div class="taskreassign">
					<b></b> <label><c:out value="${proposalTaskStatus}" /></label> <input 
					class="button" type="submit" value="Finish Task" name="finish"
						id="completePsrButton" />
				</div>
			</div>
		...
		<div class='Column2'>
			...
			<div class="formcontainer">
				...
				<div class="formcontainer">
					...
					<d:content isReadOnly="${screenReadOnly}">
						<div class="row">
							<span class="label" style="height : 140px"><label class='required'>&#42;</label>Basis for Contracting Out:
							...
							<span class="error clear" style="margin-left:36%;"></span>
						</div>
						<div class="row">
							<span class="label" sytle="height:3opx;"><label class='required'>&#42;</label>Anticipated Level of Competition:</span> 
							<span class="formfield"> <select
								id="anticipateLevelComp" name="anticipateLevelComp">
							...
							</span> <span class="error clear" style="margin-left:36%;"></span>
						</div>

						<div class="row">
							<span class="label" style="height : 60px;"><label class='required'>&#42;</label>Consideration of Price:</span> <span class="formfield">
								<textarea  id="considerationPrice"	name="considerationPrice" onkeyup="setMaxLength(this,1000)"	onkeypress="setMaxLength(this,1000)"
								style="width: 324px;resize: none;height:60px;" >${PsrDataBean.considerationPrice}</textarea>
								</span>
									<span class="error clear" style="margin-left:36%;"></span>
						</div>
						...
						<div class="row">
							<span class="label">Concept Report Release Date:</span> <span class="formfield"> <form:input
									path="conceptReportReleaseDt" value="${conceptReportReleaseDt}"
						...
						<!-- Removed JSTL condition for Defect 8404 -->
						...
						<c:if test="${(PsrDataBean.isOpenEndedRFP eq '0')}">
							...
							<div class="row">
								<span class="label"><label class='required'>&#42;</label>Renewal Options:
									</span>
										<span class="formfield"><input type="text" rows="1" maxlength="100"	cols="35" name="renewalOption" style="width:324px;" id="renewalOption" value="${PsrDataBean.renewalOption}"/>
									   </span>
									   <span class="error clear" style="margin-left:36%;"></span>
							</div>
						</c:if>
						...
						<div class="row">
								<span class="label">Renewal Options:
										...
										<span class="formfield"><input class="ignoreValidate" type="text" rows="1" maxlength="100"
												cols="35" name="renewalOption" style="width:324px;" id="renewalOption" value="${PsrDataBean.renewalOption}"/>
									   </span>									 
							</div>
						</c:if>
						<h3>Multi-Year Human Services Contract</h3>
						<div class="row">
							<span class="label"><label class='required'>&#42;</label>The ACCO has determined that the needs
								...
								to § 2-04(d)(2) of the PPB rules, because:
							</span> <span class="formfield"><textarea id="multiYearHumanServContract" rows="10" style="width:324px;resize: none;" onkeyup="setMaxLength(this,1000)"
							onkeypress="setMaxLength(this,1000)" name="multiYearHumanServContract">${PsrDataBean.multiYearHumanServContract}</textarea>
							</span>
							<span class="error clear" style="margin-left:36%;"></span>
						</div>
						<div class="row">
							<span class="label" sytle="height:82px;"><label class='required'>&#42;</label>The ACCO has determined, that pursuant
								to § 2-04(e) of the PPB Rules that the contract(s) awarded from
								this procurement will fall within the parameters of:</span> <span class="formfield">
								<div id="checkbox_div">
						...
						<div class="row">
							<span class="label"><label id="showMandatory" class='required'>&#42;</label>The ACCO has determined that although
							...
							<span class="formfield"><textarea id="multiYearHumanServOpt" rows="11"  style="width:324px;resize: none;"
									onkeyup="setMaxLength(this,1000)" onkeypress="setMaxLength(this,1000)"name="multiYearHumanServOpt">${PsrDataBean.multiYearHumanServOpt}</textarea>
							</span>
							<span class="error clear" style="margin-left:36%;"></span>
						</div>
					</d:content>
			...
			<c:if test="${(taskDetailsBean.isOpenEndedRfp eq 'No') &&(PsrDataBean.estProcurementValue > 0)}">
				...
				<c:if test="${showPsrFundingSubGrid}">
				<P>&nbsp;</P>
			...
			<div id='contractTabs'>
				...
				<div id='Comments'>
					<div class="row" >
						...
						<p>Enter any comments. These comments will be available to HHS Accelerator. Click the &quot;Save&quot;
						...
						<textarea rows="5" class='textarea' id="internalComments"
							...
							onkeypress="setMaxLength(this,1000)">${internalComments}</textarea><span class="error"></span>
						</span>
		...
		<%--PCOF Popup--%>
		<div class="alert-box alert-box-completepsr skipElementsInCompare">
			<div class='tabularCustomHead'>Submit PSR</div>
			...
			<div id="requestCancel" class="popupPadding">
				...
				<p>Are you sure you want to submit the PSR form?</p>
				<p>
					After submission of the form, the PSR will be sent to Accelerator for<br>
				...
				<div class="buttonholder">
					<input type="button" class="graybtutton" title=""
						value="No, do not submit form" id="btnNotSubmitCB" onclick="cancelOverLay()" /> <input
						type="button" class="button" title="" value="Yes, submit form"
