...
/**
 * This is a test class for FloatLessThanEqualsHandler class
 * 
 */
public class FloatLessThanEqualsHandlerTest
{
	 ...
	 * set and it's value(in channel variable) is less than or equal the value
	 * set in expression's 'value' attribute.
	 * */
	@Test
	public void testEvaluateBusinessRuleReturnTrue() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "8.90");
			...
			FloatLessThanEqualsHandler loFloatLessThanEqualsHandler = new FloatLessThanEqualsHandler();
			boolean loResult = (Boolean) loFloatLessThanEqualsHandler.evaluateBusinessRule(loExpression);
			assertTrue(loResult);
	 ...
	 * set and it's value(in channel variable) is not less than or equal the
	...
	public void testEvaluateBusinessRuleReturnFalse() throws ApplicationException
	{
		try
		{
			...
			setElementAttribute("channel_variable", "testChVar");
			setElementAttribute("value", "10.3");
			Expression loExpression = new Expression(moExpressionElement, moChannel);
	...
	public void testEvaluateBusinessRuleReturnFalseScennario2() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "111.98");
			setElementAttribute("channel_variable", "testChVar");
			setElementAttribute("value", "11.39");
			Expression loExpression = new Expression(moExpressionElement, moChannel);
	 ...
	 * 'channel_variable'(in channel) is less than or equal to value
	...
	public void testEvaluateBusinessRuleChannelVar2AvailableReturnTrueScennario2() throws ApplicationException
	{
		try
		{
			...
			moChannel.setData("testChVar2", "199.0");
	 ...
	 * 'channel_variable2' attributes are set and value corresponding to
	 * 'channel_variable'(in channel) is not less than or equal to value
	 * corresponding to 'channel_variable2'(in channel)
	 * */
	@Test
	public void testEvaluateBusinessRuleChannelVar2AvailableReturnFalse() throws ApplicationException
	{
		try
		{
			...
			moChannel.setData("testChVar2", "16.0");
	...
	public void testEvaluateBusinessRuleForTypeMismatchInValueScennario2() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "232.0");

			setElementAttribute("channel_variable", "testChVar");

			setElementAttribute("value", "17df2nonFloat");
			Expression loExpression = new Expression(moExpressionElement, moChannel);
	 ...
	 * */
	@Test
	public void testEvaluateBusinessRuleForTypeMismatchInFirstChannelVarScennario2() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "172NonFloatValue");
			...
			setElementAttribute("value", "1553.0.");
			Expression loExpression = new Expression(moExpressionElement, moChannel);
