//This method is called on load of overlay
...
//This method enables or disable user name or password on click of check box
...
//This method submits submit the overlay form
	...
	jQuery.ajax({
		...
		success : function(result) {
			...
			} else if(result["error"] == 2) // Application exception
			{
				...
				document.submitCBForm.action = $("#submitConfirmation").val()+"&publicCommentArea="+convertSpecialChar($("#publicCommentArea").val())+"&internalCommentArea="+convertSpecialChar($("#internalCommentArea").val());
