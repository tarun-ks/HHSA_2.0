...
<portlet:resourceURL var='SubGridHeaderRow' id='SubGridHeaderRow'	escapeXml='false'>
	<portlet:param name="gridLabel" value="modification.UnallocatedFunds.grid" />
</portlet:resourceURL>
...
<c:set var="gridColNames"><%=HHSUtil.getHeader("modification.UnallocatedFunds.grid")%></c:set>
<c:set var="gridColProp"><%=HHSUtil.getHeaderProp("modification.UnallocatedFunds.grid")%></c:set>
<c:set var="subGridColProp"><%=HHSUtil.getSubGridProp("modification.UnallocatedFunds.grid")%></c:set>
...
<%-- JGrid for adding dynamic table --%>
	   <jq:grid id="unallocatedFundsModGrid-${subBudgetId}" 
