...
import com.nyc.hhs.taskhandlers.BudgetUpdateTaskHandler;
import com.nyc.hhs.util.PropertyLoader;

public class BudgetUpdateTaskHandlerTest {


	private static SqlSession moSession = null; // SQL Session

	BudgetUpdateTaskHandler loBudgetUpdateTaskHandler = new BudgetUpdateTaskHandler();
...
//		JUnitUtil.getTransactionManager();
	...
	public void testTaskApprove() throws ApplicationException
	{
		...
		loBudgetUpdateTaskHandler.taskApprove(loTaskDetailsBean);
	}
	...
	{
		loBudgetUpdateTaskHandler.taskReturn(null);
	}
	...
	public void testTaskReturn2() throws ApplicationException
	{
		...
		loBudgetUpdateTaskHandler.taskReturn(loTaskDetailsBean);
	}
	...
	public void testBudgetUpdateTaskHandlertaskApprove0NegativeApp() throws ApplicationException
	{
		BudgetUpdateTaskHandler loBudgetUpdateTaskHandler = new BudgetUpdateTaskHandler();
		loBudgetUpdateTaskHandler.taskApprove(null);
	}

	@Test(expected = ApplicationException.class)
	public void testBudgetUpdateTaskHandlertaskReturn1NegativeApp() throws ApplicationException
	{
		BudgetUpdateTaskHandler loBudgetUpdateTaskHandler = new BudgetUpdateTaskHandler();
		loBudgetUpdateTaskHandler.taskReturn(null);
	}
	...
	public void testBudgetUpdateTaskHandlertaskApprove0Negative()
	{
		BudgetUpdateTaskHandler loBudgetUpdateTaskHandler = new BudgetUpdateTaskHandler();
		try
		{
	...
	@Test(expected = java.lang.Exception.class)
	public void testBudgetUpdateTaskHandlertaskReturn1Negative()
	{
		BudgetUpdateTaskHandler loBudgetUpdateTaskHandler = new BudgetUpdateTaskHandler();
		try
		{
