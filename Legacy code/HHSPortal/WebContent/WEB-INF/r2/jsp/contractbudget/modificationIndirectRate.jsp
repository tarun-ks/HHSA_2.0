...
<portlet:param name="gridLabel" value="modificationBudgetIndirectRate.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames"><%=HHSUtil.getHeader("modificationBudgetIndirectRate.grid")%></c:set>
<c:set var="gridColProp"><%=HHSUtil.getHeaderProp("modificationBudgetIndirectRate.grid")%></c:set>
<c:set var="subGridColProp"><%=HHSUtil.getSubGridProp("modificationBudgetIndirectRate.grid")%></c:set>
