...
public class AccountsAllocationBean extends CBGridBean
{
	...
	private String total = HHSConstants.STRING_ZERO;
	...
	private String newFYFiscalYearId = HHSConstants.EMPTY_STRING;
	private boolean deletedRecord = HHSConstants.INITIALIZATION_FALSE;

	public String getNewFYFiscalYearId()
	{
		return newFYFiscalYearId;
	}

	public void setNewFYFiscalYearId(String newFYFiscalYearId)
	{
		this.newFYFiscalYearId = newFYFiscalYearId;
	}
	...
	{
		return "AccountsAllocationBean [id=" + id + ", chartOfAccount=" + chartOfAccount + ", subOc=" + subOc + ", rc="
				...
				+ contractEndFY + ", paymentId=" + paymentId + ", contractTypeId=" + contractTypeId
				+ ", modifyByProvider=" + modifyByProvider + ", modifyByAgency=" + modifyByAgency
				+ ", newFYFiscalYearId=" + newFYFiscalYearId + ", deletedRecord=" + deletedRecord + "]";
	}
