<!--
    The borderlayout skeleton file renders a HTML DIV element for the layout. Each placeholder is rendered as
    ...
    An additional HTML DIV container is rendered around the west, center and east placeholders to implement a
    float clearing strategy based on based on http://www.quirksmode.org/css/clearing.html.
-->
...
>
    ...
    <skeleton:context type="borderlayoutpc">
        ...
        <skeleton:control name="div" presentationContext="${borderlayoutpc}"
            presentationClass="wlp-bighorn-layout wlp-bighorn-layout-border"
        >
            <c:if test="${! empty borderlayoutpc.north}">
                ...
                <skeleton:control name="div" presentationContext="${borderlayoutpc.north}"
                    presentationClass="wlp-bighorn-layout-cell wlp-bighorn-layout-border-north"
            ...
            <c:if test="${! empty borderlayoutpc.west || ! empty borderlayoutpc.center || ! empty borderlayoutpc.east}">
                <div class="wlp-bighorn-layout-border-wce-container">
                    <c:if test="${! empty borderlayoutpc.west}">
                        ...
                        <skeleton:control name="div" presentationContext="${borderlayoutpc.west}"
                            presentationClass="wlp-bighorn-layout-cell wlp-bighorn-layout-border-west"
                    ...
                    <c:if test="${! empty borderlayoutpc.center}">
                        ...
                        <skeleton:control name="div" presentationContext="${borderlayoutpc.center}"
                            presentationClass="wlp-bighorn-layout-cell wlp-bighorn-layout-border-center"
                    ...
                    <c:if test="${! empty borderlayoutpc.east}">
                        ...
                        <skeleton:control name="div" presentationContext="${borderlayoutpc.east}"
                            presentationClass="wlp-bighorn-layout-cell wlp-bighorn-layout-border-east"
            ...
            <c:if test="${! empty borderlayoutpc.south}">
                ...
                <skeleton:control name="div" presentationContext="${borderlayoutpc.south}"
	               presentationClass="wlp-bighorn-layout-cell wlp-bighorn-layout-border-south"
