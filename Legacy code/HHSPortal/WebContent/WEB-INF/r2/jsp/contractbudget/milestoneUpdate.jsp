...
<%-- This JSP is for screen S417 Milestone - Contract Budget Update. --%>
...
<portlet:param name="gridLabel" value="contractBudgetUpdateMilestone.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames"><%=HHSUtil.getHeader("contractBudgetUpdateMilestone.grid")%></c:set>
<c:set var="gridColProp"><%=HHSUtil.getHeaderProp("contractBudgetUpdateMilestone.grid")%></c:set>
<c:set var="subGridColProp"><%=HHSUtil.getSubGridProp("contractBudgetUpdateMilestone.grid")%></c:set>
...
<jq:grid id="milestoneUpdateGrid-${subBudgetId}" 
