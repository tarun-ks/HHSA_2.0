...
<%-- 
This jsp is used for S329 Assignment in Contract Invoice screen.
--%>
...
<portlet:resourceURL var="addAssigneeOverlay" id="addAssigneeOverlay" escapeXml="false" />
<input type="hidden" id="addAssigneeOverlayVar" value="${addAssigneeOverlay}"/>
