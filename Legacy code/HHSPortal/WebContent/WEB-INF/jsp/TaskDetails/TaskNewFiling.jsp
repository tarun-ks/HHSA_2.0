...
<script type="text/javascript" src="../framework/skeletons/hhsa/js/TaskNewFiling.js"></script>
...
<% 
	...
	boolean lbSecurityCheck=CommonUtil.getConditionalRoleDisplay(ComponentMappingConstant.TA_S082_PAGE, request.getSession());
...
<%if(lbSecurityCheck){%>
	...
	<div class="tasktopfilter taskButtons">
		...
		<div class="taskreassign">
			<select id="finishtaskchild" name="finishtaskchild" onchange="enableFinishButton()">
				<c:forEach var="category" items='<%=request.getAttribute("finishStatusFiling") %>'>
	...
	<div id="tabs">
		<ul>
			...
			<li><a href="#tabs-2" title="Add Service Comments">Add Comments</a></li>
		...
		<div class="tabularWrapper">
			...
			<st:table
				...
				columnName="msQuestionDocumentName" align="center" size="20%">
					<st:extension
...
function finishCall(){
	...
	if('<%=lbSecurityCheck%>'){
		...
		if(document.getElementById('finishtaskchild').value=='<%=ApplicationConstants.STATUS_RETURNED%>'){
