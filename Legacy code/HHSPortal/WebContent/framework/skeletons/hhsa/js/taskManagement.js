/**
 * ==========================================================
 * This js file handle the events on task management screen.
 * It also render the grid of various task.
 * ==========================================================
 */
...
function submitForm(taskid, isTaskLock, isManagerTask, lsStatus) {
	...
	if(($("#awardTaskName").text()=="Approve PSR") || ($("#awardTaskName").text()=="Approve Award Amount")){
		document.myTaskMform.action = document.myTaskMform.action + '&taskid='
	...
	document.myTaskMform.action = document.myTaskMform.action + '&taskid='
			...
			+ isManagerTask + '&taskStatus=' + lsStatus
			+ '&fromTaskManagementPage=true&awardTaskName='
			+ $("#awardTaskName").text();
	document.myTaskMform.submit();
	}
}
...
/**
 * Method submit the form on click of reserve link.
 * 
 */
function reserveJob(reserveId) {
	pageGreyOut();
	document.myTaskMform.action = document.myTaskMform.action + '&reserveId='
			+ reserveId + "&next_action=reserveTask&action=paging";
	document.myTaskMform.submit();
}
/**
 * Method submit the form on click of reserve Task.
 * 
 */
function reserveTask(workflowId, taskName) {
	pageGreyOut();
	document.myTaskMform.action = document.myTaskMform.action + '&workflowId='
			+ workflowId + "&awardTaskName=" + taskName + "&submit_action=reserveTask&action=paging";
	document.myTaskMform.submit();
}
...
function paging(pageNumber) {
	document.myTaskMform.action = document.myTaskMform.action + "&pageIndex="
...
function sort(columnName, sortType) {
	document.myTaskMform.action = document.myTaskMform.action + "&columnName="
...
function filtertask() {
	...
	if (isValid) {
		...
		document.myTaskMform.action = document.myTaskMform.action
				+ "&filteristrue=yes&usewindow=taskmanager";
		document.myTaskMform.submit();
	}
}

/**
 * This is called onchange of tasktype
 */
