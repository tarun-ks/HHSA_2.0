<!--
    The titlebar skeleton file renders a HTML DIV element for the titlebar.  This DIV element contains up to
    three additional DIV elements corresponding to the window icon, window title and window buttons.
-->
