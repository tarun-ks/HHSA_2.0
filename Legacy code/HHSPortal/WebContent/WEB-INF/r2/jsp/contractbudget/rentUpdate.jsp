...
<%-- 
This jsp is used for S383 Rent update Rate.
--%>
...
<%--
This file is designed to display Rent Grid for S382 Rent update module.
 --%>

<h3>OTPS - Rent</h3>
<%-- Resource URL to display Rent Grid header row --%>
<portlet:resourceURL var='SubGridHeaderRow' id='SubGridHeaderRow' escapeXml='false'>
<portlet:param name="gridLabel" value="updateBudgetRent.grid"/>
</portlet:resourceURL>
...
<portlet:resourceURL var='rentUpdateOperationGrid' id='gridOperation' escapeXml='false'>
<portlet:param name="transactionName" value="modificationBudgetRent"/>
<portlet:param name="beanName" value="com.nyc.hhs.model.Rent"/>
<portlet:param name="parentSubBudgetId" value="${parentSubBudgetId}"/>
<portlet:param name="subBudgetId" value="${subBudgetId}"/>
...
<c:set var="gridColNames"><%=HHSUtil.getHeader("updateBudgetRent.grid")%></c:set>
<c:set var="gridColProp"><%=HHSUtil.getHeaderProp("updateBudgetRent.grid")%></c:set>
<c:set var="subGridColProp"><%=HHSUtil.getSubGridProp("updateBudgetRent.grid")%></c:set>

  <jq:grid id="rentUpdateGrid-${subBudgetId}" 
	     ...
	     cellUrl="${rentUpdateOperationGrid}" 
	     editUrl="${rentUpdateOperationGrid}" 
	     dataType="json" 
	     methodType="POST"
