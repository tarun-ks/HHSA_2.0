...
<portlet:actionURL var="confirmProgramInactivationUrl" id="confirmProgramInactivationUrl" escapeXml='false'>
	<portlet:param name="submit_action" value="confirmProgramInactivation" />
</portlet:actionURL>

<div class="overlaycontent">
	<form action="${confirmProgramInactivationUrl}" method="post" name="ProgramInactivationForm" id="ProgramInactivationForm">
		...
		<div id="formcontainer1" class="formcontainer">
			<div class="pad10">Please review the new Program Name and Agency information below that you would like to inactivate.</div>
			...
			<div class='buttonholder'>
	            ...
	            <input type="submit" value="Inactivate" title="Inactivate" name="inactivateProgram" id="inactivateProgram" />
			</div> 
		</div>
	</form>
</div>
