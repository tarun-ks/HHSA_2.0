 ...
 * 
 */
public class PreprocessingR3Budget implements PreProcessingNotificationAlert
{
	private static final LogInfo LOG_OBJECT = new LogInfo(PreprocessingR3Budget.class);
