...
<portlet:param name="gridLabel" value="modificationBudgetSalariedEmployee.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames"><%=HHSUtil.getHeader("modificationBudgetSalariedEmployee.grid")%></c:set>
<c:set var="gridColProp"><%=HHSUtil.getHeaderProp("modificationBudgetSalariedEmployee.grid")%></c:set>
<c:set var="subGridColProp"><%=HHSUtil.getSubGridProp("modificationBudgetSalariedEmployee.grid")%></c:set>
...
<portlet:param name="gridLabel" value="modificationBudgetHourlyEmployee.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames1"><%=HHSUtil.getHeader("modificationBudgetHourlyEmployee.grid")%></c:set> 
<c:set var="gridColProp1"><%=HHSUtil.getHeaderProp("modificationBudgetHourlyEmployee.grid")%></c:set> 
<c:set var="subGridColProp1"><%=HHSUtil.getSubGridProp("modificationBudgetHourlyEmployee.grid")%></c:set> 
<br>
...
<portlet:param name="gridLabel" value="modificationBudgetSeasonalEmployee.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames2"><%=HHSUtil.getHeader("modificationBudgetSeasonalEmployee.grid")%></c:set> 
<c:set var="gridColProp2"><%=HHSUtil.getHeaderProp("modificationBudgetSeasonalEmployee.grid")%></c:set> 
<c:set var="subGridColProp2"><%=HHSUtil.getSubGridProp("modificationBudgetSeasonalEmployee.grid")%></c:set> 
<br>
...
<portlet:param name="gridLabel" value="modificationBudgetFringeBenifits.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames3"><%=HHSUtil.getHeader("modificationBudgetFringeBenifits.grid")%></c:set> 
<c:set var="gridColProp3"><%=HHSUtil.getHeaderProp("modificationBudgetFringeBenifits.grid")%></c:set> 
<c:set var="subGridColProp3"><%=HHSUtil.getSubGridProp("modificationBudgetFringeBenifits.grid")%></c:set> 
<br>
<jq:grid id="fringeBenifitsGrid-${subBudgetId}_"
	isReadOnly="${readOnlyPageAttribute}"
	gridColNames="'Fringe Benefits','Approved FY Budget','Remaining Amount','','Modification Amount','Proposed Budget'"
