...
/**
 * This class will preprocess the Notification NT234 in case when the
 * Notification is sent to all the agency users irrespective of their user role
 * 
 */
public class PreprocessingNT234 implements PreProcessingNotificationAlert
{

	private static final LogInfo LOG_OBJECT = new LogInfo(PreprocessingNT234.class);
			...
			throws ApplicationException
	{
		...
		try
		{
			...
			loUserEmailList = (List<UserEmailIdBean>) DAOUtil.masterDAO(aoMyBatisSession, loUserGroupMap,
					ApplicationConstants.MAPPER_CLASS_NOTIFICATION_MAPPER, HHSConstants.FETCH_CITY_USERS_NT234,
					HHSConstants.JAVA_UTIL_HASH_MAP);

		}
		catch (ApplicationException aoExp)
		{
			LOG_OBJECT.Error("Error occurred while PreprocessingNT234:", aoExp);
		}
		catch (Exception loExp)
		{
			LOG_OBJECT.Error("Error occurred while PreprocessingNT234:", loExp);
		}
