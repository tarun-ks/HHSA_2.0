...
jQuery.validator.addMethod('noneSelected',
	...
	if (element.value == '-1' || element.value ==" " || $(element).prop("selectedIndex") == 0)
	{return false;}
	else{return true;}
	},
...
jQuery.validator.addMethod('allowSpecialChar',
		function(value, element, param) {
...
jQuery.validator.addMethod("validateDate",
        function(value, element, param) {
	return this.optional(element) || ValidateDate(document.getElementById($(element).attr("id")));
}, "! Please eneter a valid Date");

jQuery.validator.addMethod('passSpecialChar',
		function(value, element, param) {
			/*Uniocode Values
			*Smart Double Quotes: u201C,u201D,u201E;
			*Smart Single Qoutes: u2018,u2019,u201A; 
			*Bullet: u2022
			*/
			// Check for Smart Double Quotes
			value = value.replace(/[\u201C|\u201D|\u201E]/g, "\"");
