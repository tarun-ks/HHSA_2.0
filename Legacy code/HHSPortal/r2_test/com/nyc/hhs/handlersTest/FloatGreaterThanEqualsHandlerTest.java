...
import com.nyc.hhs.handlers.FloatGreaterThanEqualsHandler;
import com.nyc.hhs.handlers.FloatGreaterThanHandler;
import com.nyc.hhs.rule.Expression;

/**
 * This is a test class for FloatGreaterThanEqualsHandler class
 * 
 */
public class FloatGreaterThanEqualsHandlerTest
{
	...
	public void testEvaluateBusinessRuleReturnTrue() throws ApplicationException
	{
		try
		{
			...
			FloatGreaterThanEqualsHandler loFloatGreaterThanEqualsHandler = new FloatGreaterThanEqualsHandler();
			boolean loResult = (Boolean) loFloatGreaterThanEqualsHandler.evaluateBusinessRule(loExpression);
			assertTrue(loResult);
	...
	public void testEvaluateBusinessRuleReturnTrueScennario2() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "101.90");
			setElementAttribute("channel_variable", "testChVar");
			setElementAttribute("value", "91.98");
			Expression loExpression = new Expression(moExpressionElement, moChannel);
	...
	public void testEvaluateBusinessRuleChannelVar2AvailableReturnTrueScennario2() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "888.0");
			moChannel.setData("testChVar2", "777.0");
	...
	public void testEvaluateBusinessRuleChannelVarExpectedButNotSetScennario2() throws ApplicationException
	{
		try
		{
			...
			moChannel.setData("testChVar2", "177.0");
	...
	public void testEvaluateBusinessRuleForTypeMismatchInValueScennario2() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "1272.0");

			setElementAttribute("channel_variable", "testChVar");

			setElementAttribute("value", "A1272nonFloat");
			Expression loExpression = new Expression(moExpressionElement, moChannel);
