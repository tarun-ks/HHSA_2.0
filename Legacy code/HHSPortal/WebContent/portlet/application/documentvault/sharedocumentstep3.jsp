...
<form id="share3" action='<portlet:resourceURL/>' method ="post" name="share3">
	<input type="hidden" name="proNameString" id="proNameString">
	<input type="hidden" name="next_action" value="" id="nextAction3">
			...
			<div class="wizardTabs" style='width:800px;'>
				<div style='padding-left:10px'>
					...
					<div class="formcontainer">
						...
						<input type="button" value="+ Add Agency" title="+ Add Agency" class="button" name="addProvider" onclick="populateTable()"/>
						<br>   </br>
