...
/**
 * This controller Class is used to Get all the Assigned Task count for Task
...
public class HomeAssignedTaskPortletView extends AbstractController implements ResourceAwareController
{
	private static final LogInfo LOG_OBJECT = new LogInfo(HomeAssignedTaskPortletView.class);
	...
	protected ModelAndView handleRenderRequestInternal(RenderRequest aoRequest, RenderResponse aoResponse)
	{
		...
		{
			LOG_OBJECT.Error("Exception in HomeAssignedTaskPortletView Controller", aoEx);
			aoRequest.setAttribute(ApplicationConstants.ERROR_MESSAGE, "Error occurred while processing your request");
		}
		ModelAndView loModelAndView = new ModelAndView(ApplicationConstants.HOME_ASSIGN_TASK_FINAL);
	...
	public ModelAndView handleResourceRequest(ResourceRequest aoRequest, ResourceResponse aoResponse)
	{
		...
		catch (ApplicationException aoAppEx)
		{
			...
			LOG_OBJECT.Error("Application Exception in HomeAssignedTaskPortletView Controller", aoAppEx);
		...
		catch (Exception aoEx)
		{
			...
			LOG_OBJECT.Error("Application Exception in HomeAssignedTaskPortletView Controller", aoEx);
			aoRequest.setAttribute(ApplicationConstants.ERROR_MESSAGE, lsErrorMsg);
		}
		UserThreadLocal.unSet();
		ModelAndView loModelAndView = new ModelAndView(ApplicationConstants.HOME_ASSIGN_TASK_FINAL);
	...
	private void getTaskCountMap(ResourceRequest aoRequest, P8UserSession aoUserSession) throws ApplicationException
	{
		...
		loChannel.setData(ApplicationConstants.INCLUDE_NOT_FLAG, ApplicationConstants.BOOLEAN_TRUE);
		...
		aoRequest.setAttribute(ApplicationConstants.TASK_COUNT_ASSIGNED_BEAN, loTaskCount);
	}
