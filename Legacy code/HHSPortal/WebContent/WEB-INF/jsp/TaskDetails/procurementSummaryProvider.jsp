			...
			<div class="formcontainer">
				...
				<d:content section="${sectionBasicInformation}">
					<div class="row">
						 ...
						 <span class="formfield">
						 	<a href="mailto:${procurementBean.accPrimaryEmail}">${procurementBean.accPrimaryContactName}</a>
						</span>
					</div>
					<div class="row">
						 <span class="label">Accelerator Secondary Contact:</span>
						<span class="formfield">
							<a href="mailto:${procurementBean.accSecondaryEmail}">${procurementBean.accSecondaryContactName}</a>
						</span>
					</div>
					<div class="row">
						<span class="label">Agency Primary Contact:</span>
						<span class="formfield">
							<a href="mailto:${procurementBean.agencyPrimaryEmail}">${procurementBean.agencyPrimaryContactName}</a>
						</span>
					</div>
					<div class="row">
						<span class="label">Agency Secondary Contact:</span>
						<span class="formfield">
							<a href="mailto:${procurementBean.agencySecondaryEmail}">${procurementBean.agencySecondaryContactName}</a>
						</span>
					</div>
				</d:content>
				...
				<div class="row">
					...
					<span class="formfield">
						<div id="procDesc" class="descriptionField" style="width:400px !important"></div>
					</span>
				</div>
				<div class="row">
			...
			<d:content section="${sectionEvaluationDates}">
				...
				<c:if test="${procurementBean.isOpenEndedRFP eq '0'}">
					...
					<div class="formcontainer openEndedHide">
						<fmt:parseDate value="${procurementBean.firstRFPEvalDateUpdated}" pattern="yyyy-MM-dd" var="formatedDate"/> 
						<fmt:formatDate value="${formatedDate}" pattern="MM/dd/yyyy" var="firstRFPEvalDateUpdated"/>
						<div class="row">
