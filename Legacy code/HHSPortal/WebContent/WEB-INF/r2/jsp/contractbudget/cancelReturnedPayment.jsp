...
<div class="alert-box alert-box-Cancel-ReturnPayment">
<input type="hidden" id="returnedPaymentId" value=""/>
		<div class="content">
		  	<div id="newTabs" class='wizardTabs'>
				...
				<div class="pad6 clear promptActionMsg" align="left">Are you sure that you want to cancel this returned payment?
					...
					<div class="buttonholder txtCenter">
						...
						<input type="button" title="Yes" class="redbtutton" id="cancelPayment" value="Yes"/>
					</div>
				</div>
			</div>
		</div>
