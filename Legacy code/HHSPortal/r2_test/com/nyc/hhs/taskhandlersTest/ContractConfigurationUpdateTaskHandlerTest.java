...
import com.nyc.hhs.taskhandlers.ContractConfigurationUpdateTaskHandler;
import com.nyc.hhs.util.PropertyLoader;

public class ContractConfigurationUpdateTaskHandlerTest {


	private static SqlSession moSession = null; // SQL Session

	ContractConfigurationUpdateTaskHandler loContractConfigurationUpdateTaskHandler = new ContractConfigurationUpdateTaskHandler();
...
//		JUnitUtil.getTransactionManager();
	...
	public void testTaskApprove() throws ApplicationException
	{
		...
		loContractConfigurationUpdateTaskHandler.taskApprove(loTaskDetailsBean);
	}
	...
	{
		loContractConfigurationUpdateTaskHandler.taskReturn(null);
	}
	...
	public void testTaskReturn2() throws ApplicationException
	{
		...
		loContractConfigurationUpdateTaskHandler.taskReturn(loTaskDetailsBean);
	}
	...
	public void testContractConfigurationUpdateTaskHandlertaskApprove0NegativeApp() throws ApplicationException
	{
		ContractConfigurationUpdateTaskHandler loContractConfigurationUpdateTaskHandler = new ContractConfigurationUpdateTaskHandler();
		loContractConfigurationUpdateTaskHandler.taskApprove(null);
	}

	@Test(expected = ApplicationException.class)
	public void testContractConfigurationUpdateTaskHandlertaskReturn1NegativeApp() throws ApplicationException
	{
		ContractConfigurationUpdateTaskHandler loContractConfigurationUpdateTaskHandler = new ContractConfigurationUpdateTaskHandler();
		loContractConfigurationUpdateTaskHandler.taskReturn(null);
	}
	...
	public void testContractConfigurationUpdateTaskHandlertaskApprove0Negative()
	{
		ContractConfigurationUpdateTaskHandler loContractConfigurationUpdateTaskHandler = new ContractConfigurationUpdateTaskHandler();
		try
		{
	...
	@Test(expected = java.lang.Exception.class)
	public void testContractConfigurationUpdateTaskHandlertaskReturn1Negative()
	{
		ContractConfigurationUpdateTaskHandler loContractConfigurationUpdateTaskHandler = new ContractConfigurationUpdateTaskHandler();
		try
		{
