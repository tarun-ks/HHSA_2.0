...
<portlet:actionURL id="finalUnShareDocument" var="finalUnShareDocument">
<portlet:param name="submit_action" value="finalUnShareDocument"/>
</portlet:actionURL>
...
<!-- Unshare overlay -->
	<form id="unshareform" name="unshareform" action="<portlet:actionURL/>" method ="post" >
		...
		<input type="hidden" id="finalUnSharing" value="${finalUnShareDocument}"/>
