<!-- Agency R4 Document Vault changes: Jsp added for Agency Document Information screen -->
...
function onReady(){
		formAction = document.agencydisplayform.action;
		displayForm = document.agencydisplayform;
		...
		$(".alert-box").find('#next2city').unbind("click").click(function() { 
			$("#agencydisplayform").validate({
				...
				submitHandler: function(form){
					document.agencydisplayform.action=formAction+'&next_action=fileupload&isAjaxCall=true';
					$(document.agencydisplayform).ajaxSubmit(options);
				    $(".alert-box").hide();
					uploadGreyOut();
				},
...
<div class="overlaycontent">
	...
	<form action="<portlet:actionURL/>" method="post" name="agencydisplayform" id="agencydisplayform">
