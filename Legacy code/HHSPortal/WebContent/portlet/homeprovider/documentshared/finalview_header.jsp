	...
	<c:choose>
		...
		<div class="appnavbar" id="nyc_app_sections">
			<ul class="roundcorners">
				...
				<jsp:scriptlet>
				/*Start : R5 Added */
				if(CommonUtil.getConditionalRoleDisplay(ComponentMappingConstant.SA_S073_S073R_PAGE, request.getSession())
							|| CommonUtil.getConditionalRoleDisplay(ComponentMappingConstant.TA_S081_PAGE, request.getSession())){
				/*End : R5 Added */
				</jsp:scriptlet>
