...
/**
 * This is a test class for IntegerLessThanEqualsHandler class
 * 
 */
public class IntegerLessThanEqualsHandlerTest
{
	...
	public void testEvaluateBusinessRuleReturnTrue() throws ApplicationException
	{
		try
		{
			...
			IntegerLessThanEqualsHandler loIntegerLessThanEqualsHandler = new IntegerLessThanEqualsHandler();
			boolean loResult = (Boolean) loIntegerLessThanEqualsHandler.evaluateBusinessRule(loExpression);
			assertTrue(loResult);
	 ...
	 * */
	@Test
	public void testEvaluateBusinessRuleChannelVar4AvailableReturnFalse() throws ApplicationException
	{
		try
		{
			moChannel.setData("testChVar", "31");
			moChannel.setData("testChVar2", "18");
	 ...
	 * */
	@Test
	public void testEvaluateBusinessRuleChannelVar1ExpectedButNotSet() throws ApplicationException
	{
		try
		{
			// moChannel.setData("testChVar", "19");
			moChannel.setData("testChVar2", "300");
