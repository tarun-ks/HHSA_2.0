package test.com.nyc.hhs.component.helper;
...
public class HHSComponentOperationsTest
{
	...
	public void setUp() throws ApplicationException
	{
		 ...
		 * "D:\\IBM\\FileNet\\ContentEngine\\config\\samples\\jaas.conf.WebLogic"
		 * ); System.setProperty("filenet.pe.bootstrap.ceuril",
		 * "http://10.155.43.80:7001/wsi/FNCEWS40MTOM/");
		 * //System.setProperty("java.naming.factory.initial",
		 * "weblogic.jndi.WLInitialContextFactory");
		 * //System.setProperty("java.security.auth.login.config",
		 * "D:\\IBM\\FileNet\\ContentEngine\\config\\samples\\jaas.conf.WebLogic"
		...
		/*
		 * try { moSession =
		 * MyBatisConnectionFactory.getLocalSqlSessionFactory().openSession(); }
	...
	public void tearDown() throws ApplicationException
	{
		Boolean lbThrown = false;
		/*
		 * try { moSession.close(); } catch (Exception loEx) { lbThrown = true;
		 * assertTrue("Exception thrown", lbThrown); }
		 */
	...
	public void testHandleAlertNotificationsForAward()
	{
		...
		try
		{
			...
			operation.handleAlertNotificationsForAward("Approved", "1734", "Test", null, null,null);
			succes = true;
	...
	public void testGetProposalIdsByProcurement()
	{
		...
		{
			HHSComponentOperations operation = new HHSComponentOperations();
			String[] proposalIds = operation.getProposalIdsByProcurement("624");
	...
	public void teststartEvaluationWorkflows()
	{
		...
		try
		{
			...
			String[] startedWorkflowIds = operation.startEvaluationWorkflows("2266",
	...
	public void teststartAcceptProposalWorkflows()
	{
		...
		try
		{
			...
			String procurementId = "3884";
			String[] startedWorkflowIds = operation.startAcceptProposalWorkflows(procurementId, null);

			WorkflowOperations wfOperation = new WorkflowOperations(new LogInfo(getClass()));
			// wfOperation.cancelWorkflows(startedWorkflowIds);
			// ("Started accept proposal workflows removed");
	...
	public void teststartReviewScoreWorkflows()
	{
		...
		try
		{
			...
			// String[] proposalIds = {"183","7"};
			String[] startedWorkflowIds = operation.startReviewScoreWorkflows(procurementId);
	...
	public void testDate()
	{
		...
		String lsDateStr = loSimpleDateFormat.format(loDate);
	...
	public void teststartContractWorkflow()
	{
		...
		try
		{
			...
			String[] proposalWobs = operation.startContractWorkflows(procurementId, true, null);
	...
	public void testcontractConInfo()
	{
		try
		{
			FinancialWFBean loFinancialWFBean = new FinancialWFBean();
			...
			loFinancialWFBean = loWorkFlowOperations.contractConInfo("660");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public void testFetchAcceleratorComments()
	{
		try
		{
			...
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			lsAccComments = loHHSComponentOperations.fetchAcceleratorComments("Invoice Review", "383");
			assertTrue(true);
		}
		catch (Exception e)
		{
	...
	public void testFetchAgencyComments()
	{
		try
		{
			String lsAccComments = null;
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			lsAccComments = loHHSComponentOperations.fetchAgencyComments("Invoice Review", "383");
			assertTrue(true);
		}
		catch (Exception e)
		{
	...
	public void testFetchEvaluatorIdsEvaluationWorkFlow()
	{
		try
		{
			String[] lsAccComments = null;
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			lsAccComments = loHHSComponentOperations.fetchEvaluatorIdsEvaluationWorkFlow("1774");
			assertTrue(true);
		}
		catch (Exception e)
		{
	...
	public void testFetchEvaluatorIdsReviewScoreWorkFlow()
	{
		try
		{
			String[] lsAccComments = null;
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			lsAccComments = loHHSComponentOperations.fetchEvaluatorIdsReviewScoreWorkFlow("764");
			assertTrue(true);
		}
		catch (Exception e)
		{
	...
	public void testInsertIntoPaymentforWF305()
	{
		...
		{
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			String[] loPaymentId = loHHSComponentOperations.insertIntoPayment("CT106820121435091", "479", "2746",
	...
	public void testInsertIntoPaymentforWF307()
	{
		...
		{
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			String[] loPaymentId = loHHSComponentOperations.insertIntoPayment("CT106820121435091", "", "2383", "10848",
					"DOC", "r3_org", "909", "", "94");
			assertTrue(true);
		}
		catch (Exception e)
	...
	public void testFetchBudgetId()
	{
		...
		{
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			String budgetId = loHHSComponentOperations.fetchBudgetId("1665", "2013");
			assertTrue(true);
		}
		catch (Exception e)
		{
	...
	public void testFetchBudgetIdfromTaskDetailsBean()
	{
		...
		{
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			String[] properties = loHHSComponentOperations
	...
	public void testFetchInvoiceNumber()
	{
		...
		{
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			String loInvoiceNumber = loHHSComponentOperations.fetchInvoiceNumber("395");
			assertTrue(true);
		}
		catch (Exception e)
		{
	...
	public void testFetchAdvanceNumber()
	{
		...
		{
			HHSComponentOperations loHHSComponentOperations = new HHSComponentOperations();
			String loAdvanceNumber = loHHSComponentOperations.fetchAdvanceNumber("130600001");
			assertTrue(true);
		}
		catch (Exception e)
		{
