...
<h5>Fiscal Year Budget Information</h5>
	...
	<div class="tabularWrapper">
		<table width="100%" cellspacing='0' cellpadding='0' border="1">				
			...
			<tr>
				<td><label id="fiscalStartDate"><fmt:formatDate pattern="MM/dd/yyyy" value="${fiscalBudgetInfo.startDate}" /></label></td>
				<td><label id="fiscalEndDate"><fmt:formatDate pattern="MM/dd/yyyy" value="${fiscalBudgetInfo.endDate}" /></label></td>
				<td><label><fmt:formatNumber type="currency" value="${fiscalBudgetInfo.approvedBudget}" /></label></td>
				<td><label><fmt:formatNumber type="currency" value="${fiscalBudgetInfo.ytdInvoicedAmount}" /></label></td>
				<td><label><fmt:formatNumber type="currency" value="${fiscalBudgetInfo.remainingAmount}" /></label></td>
				<td><label><fmt:formatNumber type="currency" value="${fiscalBudgetInfo.ytdActualPaid}" /></label></td>
				<td><label><fmt:formatNumber type="currency" value="${fiscalBudgetInfo.cashBalance}" /></label></td>
				<td><label><fmt:formatNumber type="currency" value="${fiscalBudgetInfo.unRecoupedAmount}" /></label></td>
			</tr>		
		</table>
	</div>
...
<h3>Invoice Information</h3>
	<div class="formcontainer paymentFormWrapper">
		...
		<div class="row">
		  ...
		  <span class="formfield">
	  			<input name="prvInvNum" id="prvInvNum" maxlength="20" type="text" value="${invoiceInfo.invoiceProvider}" onchange="setFieldChangeFlag();" title="This field is available for Providers to tag this invoice with their own internal invoice number. This field is optional."/>
		  </span>
		</div>
		<div class="row">
		  <span class="label">Service Date From:</span>
		  <span class="formfield"><input id="invStartDate" name="invStartDate" validate="calender" maxlength="10"  type="text" onchange="setFieldChangeFlag();" class='date' value="${invoiceInfo.invoiceStartDate}"/>
		  <img src="../framework/skins/hhsa/images/calender.png"
		class="imgclassPlanned"
		onclick="NewCssCal('invStartDate',event,'mmddyyyy');return false;">
		  </span>
	...
	<div class="row">
		...
		<div class="row">
		  ...
		  <span class="formfield"><input id="invEndDate" name="invEndDate" validate="calender" maxlength="10" onchange="setFieldChangeFlag();" type="text" class='date' value="${invoiceInfo.invoiceEndDate}" />
		  <img src="../framework/skins/hhsa/images/calender.png" class="imgclassPlanned"
			onclick="NewCssCal('invEndDate',event,'mmddyyyy');return false;"></span>
			 <span class="error"></span>
		</div>
		<div class="row">
