...
<%-- Submit Budget Modification Overlay Popup Start --%>
<portlet:defineObjects />

<script type="text/javascript"
	src="${pageContext.servletContext.contextPath}/r2/js/submitCBMConfirmation.js"></script>
...
<div class="tabularContainer">
	<h2>Submit Budget Modification</h2>
	<div class='hr'></div>
		<div class="failed" id="errorMsg"></div>
		<p>Are you sure you want to submit the Contract Budget Modification?</p>
	...
	<div class="formcontainer">
		<div class="row">
			<span class='label clearLabel autoWidth'> 
				...
				<label for='chkSubmitCBForm'>I agree to submit this Budget Modification to the Agency for review.</label>
			</span>
...
<%-- Form tag Starts --%>
	...
	<div class="buttonholder">
		<input type="button" class="graybtutton" title="" value="No, do NOT submit this Modification" id="btnNotSubmitCB" /> 
		<input type="button" class="button" title="" value="Yes, submit this Modification" id="btnSubmitCB" />
	</div>
</div>
