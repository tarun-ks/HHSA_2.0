...
<script type="text/javascript"
	src="${pageContext.servletContext.contextPath}/r2/js/agencyTaskManagement.js"></script>
...
<%@include file="/WEB-INF/r2/defaultTaskAssignment.jsp" %>
	...
	<div id=unfiltered>Below is the list of selected tasks currently assigned to your Agency. Use the filter to view other task types.</div>
		</c:when>
	</c:choose>
	...
	<div class="hr"></div>
		...
		<div class="tasktopfilter">
			<div class="taskfilter taskButtons">
				...
				<%-- Added below hidden field to differentiate the scenario for enhancement id 6361 --%>
				<input type="hidden" id="enableBulkAssign" value="${enableBulkAssign}"/>
			...
			<c:choose>
				...
				<div class="taskreassign" id='reassigndiv' style='${filterchecked}'>
					...
					<!--Start Added in R5 -->
					<input type="hidden" name="askFlag" value="" id="askFlag" />
					<!--End Added in R5 -->
			 ...
			 <st:table objectName="agencyTaskItemList" pageSize="${allowedObjectCount}" cssClass="heading"
				...
				<st:property headingName="Procurement/Contract Title" columnName="procurementTitle" sortType="procurementTitle" sortValue="asc"
					...
					<%-- Start || Changes done for enahncement 6636 for Release 3.12.0 --%>	 
 				    <c:choose>
					<c:when test="${(loFilterToBeRetained.taskName eq 'Review Scores')}">   
