<%-- This jsp used to display the help documents for provider --%>
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/r2/js/helpdocuments.js"></script>
...
<form name="helpform" action="<portlet:actionURL/>" method ="post" >
	<input type="hidden" value="" id="nextAction" name="action"/>
	<input type="hidden" value="" id="nextPageParam" name="nextPageParam"/>
	<input type="hidden" value="provider_org" id="requestingOrgType" name="requestingOrgType"/>
