...
<div class="complianceWrapper">
	<task:taskContent workFlowId="" taskType="taskContractConfiguration" isTaskScreen="" level="header" taskDetail="" ></task:taskContent>
		...
		<div id="contractTabs" class='financeTabbs'>
				...
				<div id='oontractFinancials'>
					...
					<div class="formcontainer paymentFormWrapper widthFull">
						 <div class="row">
							  ...
							  <span class="formfield"><label id="aoProcurementValue">${aoContractData.procurementValue}</label></span>
						 </div>
						 						 <div class="row">
							  <span class="label">Competition Pool:</span>
							  <span class="formfield">${aoContractData.compPoolTitle}</span>
						 </div>
						<div class="row">
						...
						<div class="row">
							...
							<span class="formfield">
								<c:choose>
									...
									<input type="text" id="contractStartDate" name="contractStartDate" validate="calender" maxlength="10"
									/>
									...
									<c:otherwise>
									${aoContractData.contractStartDate}
									</c:otherwise>
								</c:choose>
							
							</span>
							<span class="error" id="errorContractStartDate"></span>
																<%--R4 updation ends--%>
						</div>
						<div class="row">
							...
							<span class="formfield">
								<c:choose>
									<c:when test="${isOpenEndedRfpStartEndDateNotSet}">
									<input type="text" id="contractEndDate" name="contractEndDate" validate="calender" maxlength="10"/>
									<img src="../framework/skins/hhsa/images/calender.png" title="Start Date" onclick="NewCssCal('contractEndDate',event,'mmddyyyy');return false;"/>
									</c:when>
									<c:otherwise>
									${aoContractData.contractEndDate}
									</c:otherwise>
							</c:choose>
							
							</span>
							<span class="error" id="errorContractEndDate"></span>
						</div>
					</div>
					...
					<c:choose>
									<c:when test="${isOpenEndedRfpStartEndDateNotSet}">
									<div style="width: 340px; margin: 0 auto; margin: 0 auto; float:right;">
									<input type="submit" class="button" value="Save" id="save" name="save" title=""
				...
				<h3>Chart of Accounts Allocation</h3>
					...
					<jq:grid id="CoAAllocation" gridColNames="${GridColNames}"
							...
							gridUrl="${mainAccountGrid}" positiveCurrency="${columnsForTotal}"
				...
				<portlet:resourceURL var='mainFundingGrid' id='mainFundingGrid' escapeXml='false'>
					<portlet:param name="screenName" value="contractConfigurationFundingGrid"/>
				</portlet:resourceURL>
			...
			<p>The optional fields below may be used to indicate the funding source allocation at the point of the initial Certification of Funds. 
...
<div class='clear'></div>
	<div class='gridFormField'>
		<task:taskContent workFlowId=""  taskType="taskContractConfiguration" showDocument="" isTaskScreen=""  level="footer"></task:taskContent>
	</div>
</div>
