...
public class PaymentReviewTaskHandlerTest {
...
//		JUnitUtil.getTransactionManager();
	...
	public void testTaskApprove() throws ApplicationException
	{
		...
		loPaymentReviewTaskHandler.taskApprove(loTaskDetailsBean);
	}
	...
	{
		loPaymentReviewTaskHandler.taskReturn(null);
	}
	...
	public void testPaymentReviewTaskHandlertaskApprove0Negative()
	{
		PaymentReviewTaskHandler loPaymentReviewTaskHandler = new PaymentReviewTaskHandler();
		try
		{
			loPaymentReviewTaskHandler.taskApprove(null);
		}
	...
	@Test(expected = java.lang.Exception.class)
	public void testPaymentReviewTaskHandlertaskReturn1Negative()
	{
		PaymentReviewTaskHandler loPaymentReviewTaskHandler = new PaymentReviewTaskHandler();
		try
		{
	...
	public void testPaymentReviewTaskHandlertaskApprove0NegativeApp() throws ApplicationException
	{
		PaymentReviewTaskHandler loPaymentReviewTaskHandler = new PaymentReviewTaskHandler();
		loPaymentReviewTaskHandler.taskApprove(null);
	}
	...
	@Test(expected = ApplicationException.class)
	public void testPaymentReviewTaskHandlertaskReturn1NegativeApp() throws ApplicationException
	{
		PaymentReviewTaskHandler loPaymentReviewTaskHandler = new PaymentReviewTaskHandler();
		loPaymentReviewTaskHandler.taskReturn(null);
	}
