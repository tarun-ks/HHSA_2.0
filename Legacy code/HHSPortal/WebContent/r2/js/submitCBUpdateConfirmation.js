...
// This method close the overlay
function clearAndCloseOverLay() {
	$("#overlayDivId").html("");
	$(".overlay").closeOverlay();
}

// This method enable or disable user name or password on click of check box
...
// This method submit submit the overlay form
...
// This method clear all the error message shown on overlay 
...
// This method validate User name and Password test box error check
