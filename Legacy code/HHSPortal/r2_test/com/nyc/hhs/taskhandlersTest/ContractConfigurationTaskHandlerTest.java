...
import com.nyc.hhs.taskhandlers.ContractConfigurationTaskHandler;
import com.nyc.hhs.util.PropertyLoader;

public class ContractConfigurationTaskHandlerTest {


	private static SqlSession moSession = null; // SQL Session

	ContractConfigurationTaskHandler loContractConfigurationTaskHandler = new ContractConfigurationTaskHandler();
...
//		JUnitUtil.getTransactionManager();
	...
	public void testTaskApprove() throws ApplicationException
	{
		...
		loContractConfigurationTaskHandler.taskApprove(loTaskDetailsBean);
	}
	...
	{
		loContractConfigurationTaskHandler.taskReturn(null);
	}
	...
	public void testTaskReturn2() throws ApplicationException
	{
		...
		loContractConfigurationTaskHandler.taskReturn(loTaskDetailsBean);
	}
	...
	public void testContractConfigurationTaskHandlertaskApprove0Negative()
	{
		ContractConfigurationTaskHandler loContractConfigurationTaskHandler = new ContractConfigurationTaskHandler();
		try
		{
			loContractConfigurationTaskHandler.taskApprove(null);
		}
	...
	@Test(expected = java.lang.Exception.class)
	public void testContractConfigurationTaskHandlertaskReturn1Negative()
	{
		ContractConfigurationTaskHandler loContractConfigurationTaskHandler = new ContractConfigurationTaskHandler();
		try
		{
	...
	public void testContractConfigurationTaskHandlertaskApprove0NegativeApp() throws ApplicationException
	{
		ContractConfigurationTaskHandler loContractConfigurationTaskHandler = new ContractConfigurationTaskHandler();
		loContractConfigurationTaskHandler.taskApprove(null);
	}
	...
	@Test(expected = ApplicationException.class)
	public void testContractConfigurationTaskHandlertaskReturn1NegativeApp() throws ApplicationException
	{
		ContractConfigurationTaskHandler loContractConfigurationTaskHandler = new ContractConfigurationTaskHandler();
		loContractConfigurationTaskHandler.taskReturn(null);
	}
