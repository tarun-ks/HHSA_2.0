<%--This jsp is launched for Invoicing contracted service screen.This jsp has three sub -budget level line item grids.Consultant,Sub-Contractor,Vendors.--%>
	...
	<div class="row">
	      ...
	      <span class="formfield">
	      	<span class='lftAmount'>
	      		<label id="totCS${subBudgetId}">${invoiceTotalAmounts}</label>
	      	</span>
	      </span>
	</div>
	<div class="row">
	      ...
	      <span class="formfield">
	      	<span class='lftAmount'>
	      		<label id="ytdIA${subBudgetId}">${ytdInvoicedAmount}</label>
	      	</span>
	      </span>
	</div>
</div>
