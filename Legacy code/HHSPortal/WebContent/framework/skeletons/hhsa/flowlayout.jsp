...
>
    ...
    <skeleton:context type="flowlayoutpc">
        <skeleton:control name="div" presentationContext="${flowlayoutpc}"
            presentationClass="wlp-bighorn-layout wlp-bighorn-layout-flow"
        >
            <c:forEach items="${flowlayoutpc.placeholders}" var="cell" varStatus="status">
                ...
                <c:choose>
                    <c:when test="${status.first}">
                        <c:set var="firstLastClass">wlp-bighorn-layout-flow-first</c:set>
                    </c:when>
                    <c:when test="${status.last}">
                        <c:set var="firstLastClass">wlp-bighorn-layout-flow-last</c:set>
                    </c:when>
                    <c:otherwise>
                ...
                <skeleton:control name="div" presentationContext="${cell}"
                    presentationClass="wlp-bighorn-layout-cell wlp-bighorn-layout-flow-${flowlayoutpc.orientation} ${firstLastClass}"
