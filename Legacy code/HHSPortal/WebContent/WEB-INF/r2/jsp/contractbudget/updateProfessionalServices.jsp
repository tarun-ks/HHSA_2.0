...
<%--
This file is designed to display Professional Service Grid for Contract Budget - Update module
 --%>
...
<portlet:param name="gridLabel" value="updateProfessionalServices.grid"/>
</portlet:resourceURL>
...
<c:set var="gridColNames"><%=HHSUtil.getHeader("updateProfessionalServices.grid")%></c:set>
<c:set var="gridColProp"><%=HHSUtil.getHeaderProp("updateProfessionalServices.grid")%></c:set>
<c:set var="subGridColProp"><%=HHSUtil.getSubGridProp("updateProfessionalServices.grid")%></c:set>
