...
<table cellspacing="0" cellpadding="0" class="grid">
	<tr>
		...
		<th class='alignCenter' title='FY Budget - YTD Actual Paid Amount'>Cash Balance</th>
		<th class='alignCenter'>Total Invoice Amount</th>
	...
	<tr>
		...
		<td class='alignRht'><fmt:formatNumber type="currency"
			value="${paymentLineDetail.invoicedAmount}" /></td>
		<td class='alignRht'><fmt:formatNumber type="currency"
