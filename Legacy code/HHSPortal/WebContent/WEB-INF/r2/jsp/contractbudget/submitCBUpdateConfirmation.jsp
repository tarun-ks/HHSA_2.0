...
<%-- This JSP open Budget Update Overlay screen on click of submit button on Budget Update main screen --%>

<%-- Submit Budget Update Overlay Popup Start --%>
<portlet:defineObjects />

<script type="text/javascript"
	src="${pageContext.servletContext.contextPath}/r2/js/submitCBUpdateConfirmation.js"></script>
...
<portlet:actionURL var="submitConfirmation" escapeXml="false">
	...
	<portlet:param name="submit_action" value="submitUpdateConfirmation" />
</portlet:actionURL>
<input type="hidden" name="submitConfirmation" id="submitConfirmation"
...
Submission </span> <a href="javascript:void(0);" class="exit-panel">&nbsp;</a></div>

<div class="tabularContainer">
<h2>Submit Budget Update</h2>
<div class='hr'></div>
<div class="failed" id="errorMsg"></div>
<p>Are you sure you want to submit the Contract Budget Update?</p>
...
<form:form id="submitCBForm" action="" method="post" name="submitCBForm">
	...
	<input type="hidden" value="${ctId}" name="ctId" id="ctId" />

	<div class="formcontainer">
		<div class="row">
			<span class='label clearLabel autoWidth'> 
				<input name="" type="checkbox" id='chkSubmitCBForm' /> 
				<label for='chkSubmitCBForm'>I agree to submit this Budget Update to the Agency for review.</label> 
			</span>
...
<%-- Form tag End --%>
	...
	<div class="buttonholder">
		<input type="button" class="graybtutton" title="" value="No, do NOT submit this Update" id="btnNotSubmitCB" /> 
		<input type="button" class="button" title="" value="Yes, submit this Update" id="btnSubmitCB" />
	</div>
</div>
