...
public class ProposalCustomQuestionValidator implements Validator
{
	/**
	...
	public void validate(Object aoObj, Errors aoError)
	{
		...
		{
			if (loQueAnsBean.getQuestionFlag() != null
					&& loQueAnsBean.getQuestionFlag().equalsIgnoreCase(HHSConstants.YES_UPPERCASE))
			{
				ValidationUtils.rejectIfEmptyOrWhitespace(aoError, HHSConstants.QUESTION_TEXT, "required.questionText",
