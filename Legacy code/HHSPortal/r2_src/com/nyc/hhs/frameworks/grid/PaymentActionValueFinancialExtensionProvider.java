 ...
 * 
 */
public class PaymentActionValueFinancialExtensionProvider implements DecoratorInterface
{
	...
	public String getControlForColumn(Object aoEachObject, Column aoCol, Integer aoSeqNo) throws ApplicationException
	{
		...
		String lsControl = loPaymentList.getPaymentProcurementTitle() == null ? loPaymentList.getPaymentContractTitle()
				: loPaymentList.getPaymentProcurementTitle();
		return lsControl;
	}
